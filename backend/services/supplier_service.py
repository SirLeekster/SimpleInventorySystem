...
def create_supplier(name: str, phone: str = None, email: str = None, address: str = None, description: str = None) -> Supplier:
    supplier = Supplier(
        name=name.strip(),
...
def update_supplier(supplier_id: int, name: str, phone: str = None, email: str = None, address: str = None, description: str = None) -> bool:
